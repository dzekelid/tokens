...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/ibm-watson/apis.md
...
- name: IBM Watson Machine Learning API - Get Entity Token
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/ibm-watson/identitytoken-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/ibm-watson/identitytoken-get-openapi.md
- name: IBM Watson Machine Learning API - Put Entity Token
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/ibm-watson/identitytoken-put-openapi.md
- name: IBM Watson Machine Learning API - Put Entity Token
  x-api-slug: identitytoken-put
  description: Refreshes token, accepts expired token and generates a new one (if
    the application binding / service key is still valid)
