...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/uebermaps/apis.md
...
- name: uebermaps - Get secret access token to share map
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/uebermaps/sharemapid-get-openapi.md
- name: uebermaps - Get secret access token to share map
  x-api-slug: sharemapid-get
  description: Get secret access token of an uebermap with access set to 'Secret link'.
    Pass the 'token' on every request you make to access this uebermap and its resources.
