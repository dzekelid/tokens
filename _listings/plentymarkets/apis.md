...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/plentymarkets/apis.md
...
- name: plentymarkets REST-API - Generate a token
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/plentymarkets/restexportsgenerate-token-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/plentymarkets/restexportsgenerate-token-get-openapi.md
- name: plentymarkets REST-API - Refresh an expired access token.
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/plentymarkets/restmarketsebayauthrefreshtoken-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/plentymarkets/restmarketsebayauthrefreshtoken-put-openapi.md
- name: plentymarkets REST-API - Refresh an expired access token.
  x-api-slug: restmarketsebayauthrefreshtoken-put
  description: Refresh an expired access token..
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/plentymarkets.png
