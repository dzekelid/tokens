...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/instructure/apis.md
specificationVersion: "0.14"
apis:
- name: Instructure Canvas Courses API - Course TODO items
  x-api-slug: coursescourse-idtodo-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/instructure/coursescourse-idtodo-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/instructure/coursescourse-idtodo-get-openapi.md
- name: Instructure Canvas Courses API - Course TODO items
  x-api-slug: coursescourse-idtodo-get
  description: Course todo items.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/820-instructure.jpg
...
- name: Instructure Canvas Users API - List the TODO items
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/instructure/usersselftodo-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tokens/master/_listings/instructure/usersselftodo-get-openapi.md
- name: Instructure Canvas Users API - List the TODO items
  x-api-slug: usersselftodo-get
  description: List the todo items.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/820-instructure.jpg
